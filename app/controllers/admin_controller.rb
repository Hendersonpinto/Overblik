class AdminController < ApplicationController
    ...
    def company_create
      ...
      if @company.save
        redirect_to admin_company_path(@company), notice: "Company successfully created"
      else
        render :company_new
      end
    end
    ...
    def vendor_create
      ...
      if @vendor.save
        redirect_to admin_vendor_path(@vendor), notice: "Vendor successfully created"
      else
        render :vendor_new
      end
    end
    ...
    def vendor_contact_create
      ...
      if @vendor_contact.save
        redirect_to admin_vendor_contact_path(@vendor_contact), notice: "vendor_contact successfully created"
      else
    ...
    def sub_category_params
      params.require(:sub_category).permit(:name, :icon)
    end
