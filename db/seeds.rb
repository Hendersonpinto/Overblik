class String
  ...
  SystemAccount.create(stripe_account: "strip try")


  puts "\nCreating users..."
    users = [
      {first_name: "Susan", last_name: "Ferguson", email: "susan@company.com", password: "123456", department: Department.first, company: Company.first, system_account: SystemAccount.first },
      # {first_name: "Peter", last_name: "Albridge", email: "peter@company.com", password: "123456", department: Department.find_by(name:"whatever"), company: Company.find_by(name: "Company")},
      # {first_name: "Mike", last_name: "Peterson", email: "mike@company.com", password: "123456", department: Department.find_by(name:"whatever"), company: Company.find_by(name: "Company")},
      # {first_name: "Carol", last_name: "Anderson", email: "carol@company.com", password: "123456", department: Department.find_by(name:"whatever"), company: Company.find_by(name: "Company")},
      # {first_name: "Kathrine", last_name: "Hudson", email: "kathrine@company.com", password: "123456", department: Department.find_by(name:"whatever"), company: Company.find_by(name: "Company")}
    ]
